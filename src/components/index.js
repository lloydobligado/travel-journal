const locations = [
    {
        ...
        description: "London Bridge is an iconic bridge in London that has spanned the River Thames since Roman times. It has played a significant role in London's history and has been the site of important events, such as the Peasants' Revolt and the Great Fire of London."
    },
    {
        id: 2,
    ...
    },
    {
        ...
        description: "Lisbon is a historic and vibrant city in Portugal, known for its colorful streets, stunning architecture, and traditional cuisine. It's home to UNESCO World Heritage Sites like the Belém Tower and the Jerónimos Monastery, and visitors can enjoy panoramic views from the São Jorge Castle or explore the city on yellow trams."
    },
    {
        id: 5,
        ...
        description: "The Algarve in southern Portugal is famous for its stunning coastline, golden beaches, and picturesque towns. It's a popular destination for outdoor activities like surfing, sailing, and hiking, and visitors can explore historic landmarks like the Moorish Castle of Silves and the Roman ruins of Milreu, or take a boat tour of the Benagil Cave."
    },
    {
        id: 6,
